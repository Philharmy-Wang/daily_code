# 基础配置文件路径
_base_ = r'C:\Users\12715\Documents\GitHub\mmdetection\configs\fcos\fcos_r50_fpn_gn-head-center-normbbox-centeronreg-giou_8xb8-amp-lsj-200e_coco.py'
...
work_dir = './work_dirs/fcos_custom'
load_from = None
resume_from = None
workflow = [('train', 1)]
