...
# 基础配置文件路径
_base_ = r'C:\Users\12715\Documents\GitHub\mmdetection\configs\deformable_detr\deformable_detr_r50_16x2_50e_coco.py'
...
work_dir = './work_dirs/deformable_detr_custom'
load_from = None
resume_from = None
workflow = [('train', 1)]
