# 导入基本配置
_base_ = r'C:\Users\12715\Documents\GitHub\mmdetection\configs\yolox\yolox_tiny_8xb8-300e_coco.py'
...
model = dict(
    ...
    data_preprocessor=dict(batch_augments=[
        dict(
            ...
            random_size_range=(320, 640),  # 随机尺寸范围
...
test_pipeline = [
    ...
    dict(type='Resize', scale=(416, 416), keep_ratio=True),  # 调整尺寸
    dict(
        type='Pad',  # 填充
        pad_to_square=True,
        pad_val=dict(img=(114.0, 114.0, 114.0))),
...
# 数据配置
data = dict(
    samples_per_gpu=8,  # 每个 GPU 的样本数
    workers_per_gpu=4,  # 每个 GPU 的工作者数
    train=dict(
